...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "canarypwn"
    user-mail-address "canarypwn@aosc.io")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/canarypwn/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/canarypwn/bin" "/profile/bin" "/Users/canarypwn/.npm-packages/bin" "/Users/canarypwn/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
